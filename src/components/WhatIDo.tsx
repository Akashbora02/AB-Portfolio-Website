        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Provisioning and managing scalable cloud infrastructure using Terraform on AWS and GCP. Deploying and managing containerized applications.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building and optimizing CI/CD pipelines and automating infrastructure provisioning to reduce manual effort and maintain high availability.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
